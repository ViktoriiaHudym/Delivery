                ...
                <Switch>
                    <Route exact path='/' component={HomePage}/>
                        ...
                        <Route exact path='/registries/' component={AuthenticatedComponent(RegistriesTable, [isAdmin, isDefaultUser])}/>
                            <Route exact path='/registries/:number(\d+)' component={AuthenticatedComponent(RegistryPage, [isAdmin, isDefaultUser])}/>
                                <Route path='/registries/:number(\d+)/edit' component={AuthenticatedComponent(EditRegistry, [isAdmin, isDefaultUser])}/>
                        ...
                        <Route exact path='/invoices/' component={AuthenticatedComponent(InvoicesTable, [isAdmin, isDefaultUser])}/>
                            <Route exact path='/invoices/:number(\d+)' component={AuthenticatedComponent(InvoicePage, [isAdmin, isDefaultUser])}/>
                                <Route path='/invoices/:number(\d+)/edit' component={AuthenticatedComponent(EditInvoice, [isAdmin, isDefaultUser])}/>
