...
export function authenticate(login, password) {
    return async function(dispatch) {
        ...
        if (response.error !== null) {
            showMessage("Перевірте ваш логін або пароль", typesMessages.error)(dispatch);
            return dispatch({
...
export function register(formData) {
    return async function(dispatch) { 
        ...
        dispatch({
            ...
            payload: { ...defaultPayload, success: { message: "Реєстрація пройшла успішно" } },
        }); 
        dispatch({
            type: CURRENT_PATH_REDIRECT,
            payload: {
        ...
        showMessage("Реєстрація пройшла успішно", typesMessages.success)(dispatch);
    }; 
}
...
export function updateInfoAboutMe() {
    ...
    return async function(dispatch) { 
        ...
        const response = await User.me(jwt);
        if (response.error !== null) {
            showMessage("Невдалося знайти інформацію", typesMessages.error)(dispatch);
            return dispatch({
...
export function changeMyPersonalInfo(username, formData) {
    ...
    return async function(dispatch) {
        ...
        const userObject = response.respBody.data;
        showMessage(`Профіль було успішно оновлено`, typesMessages.success)(dispatch);
        dispatch({
