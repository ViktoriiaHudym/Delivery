    ...
    render() {
        return (
            <React.Fragment>
                ...
                <p>
                    Якщо у вас <b>вже є обліковий запис</b>, увійдіть, будь ласка, на сторінці <Link to="/login" className="link-style">входу</Link>.
                </p>
                <p>
                    Усі поля є необхідними для заповнення:
                </p>
